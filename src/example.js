! function(t) {
                  ...
                  for (; a.nextNode();) {
                      ...
                      if (1 === e.nodeType) {
                          ...
                          const r = e.parentNode,
                              ...
                              a = s.length - 1;
                          i += a;
                          for (let t = 0; t < a; t++) r.insertBefore("" === s[t] ? f() : document.createTextNode(s[t]), e), this.parts.push({
                              type: "node",
                              index: n++
                          });
                          ...
                          if (e.nodeValue === l) {
                              ...
                              let t = -1;
                              for (; - 1 !== (t = e.nodeValue.indexOf(l, t + 1));) this.parts.push({
                                  type: "node",
                                  index: -1
                              })
                          }
  ...
  function R(t, e) {
      const {
          ...
          parts: i
      } = t, o = document.createTreeWalker(n, O, null, !1);
      let r = F(i),
          s = i[r],
          a = -1,
          l = 0;
      ...
      for (; o.nextNode();) {
          ...
          for (t.previousSibling === u && (u = null), e.has(t) && (c.push(t), null === u && (u = t)), null !== u && l++; void 0 !== s && s.index === a;) s.index = null !== u ? -1 : s.index - l, s = i[r = F(i, r)]
      }
          ...
          bind(e) {
              Array.from(this.shadowRoot.querySelectorAll("[attribute]")).forEach(n => {
                  ...
                  this.addEventListener(i, n => {
                      t.Tone.isDefined(e[i]) && (t.Tone.isDefined(e[i].value) ? e[i].value = n.detail : e[i] = n.detail), this.sync(e)
                  })
      ...
      p(jt, zt), d(jt, ft, zt.values), p(jt, {
          ...
          y ? (f = n(function(t, n, i, o) {
              ...
              var r, s, a, l, h = 0,
                  p = 0;
              if (_(n)) {
                  if (!(n instanceof W || "ArrayBuffer" == (l = x(n)) || "SharedArrayBuffer" == l)) return yt in n ? It(f, n) : Tt.call(f, n);
                  r = n, p = Et(i, e);
                  var m = n.byteLength;
                  if (void 0 === o) {
  ...
  function B(t, e, n, i, o, r) {
      ...
      for (var a = t[N]._b, l = s + t[O], c = i(+o), u = 0; u < e; u++) a[l + u] = c[r ? u : e - u - 1]
  }
  if (s.ABV) {
      if (!c(function() {
              x(1)
          ...
          for (var G, U = (x = function(t) {
              ...
              })[g] = k[g], W = f(k), Y = 0; W.length > Y;)(G = W[Y++]) in x || a(x, G, k[G]);
          r || (U.constructor = x)
      }
      var K = new _(new x(2)),
          J = _[g].setInt8;
  ...
  t.exports = function(t) {
      return function(e) {
          for (var n, s = o(e), a = i(s), l = a.length, c = 0, u = []; l > c;) r.call(s, n = a[c++]) && u.push(t ? [n, s[n]] : s[n]);
          return u
      }
  }
}, function(t, e, n) {
  ...
  var i = n(8),
      ...
      s = n(14);
  t.exports = function(t, e) {
      for (var n, a = r(s(e)), l = a.length, c = 0; l > c;) i.f(t, n = a[c++], o.f(e, n));
      return t
  }
}, function(t, e) {
  t.exports = function(t) {
  ...
  ! function(o) {
      ...
      function C(t, e) {
          e = e || 6;
          for (var n = d(t).toHsv(), i = n.h, o = n.s, r = n.v, s = [], a = 1 / e; e--;) s.push(d({
              h: i,
              s: o,
              v: r
          })), r = (r + a) % 1;
      ...
      d.prototype = {
          ...
          toHex8: function(t) {
              return function(t, e, n, i, o) {
                  ...
                  if (o && r[0].charAt(0) == r[0].charAt(1) && r[1].charAt(0) == r[1].charAt(1) && r[2].charAt(0) == r[2].charAt(1) && r[3].charAt(0) == r[3].charAt(1)) return r[0].charAt(0) + r[1].charAt(0) + r[2].charAt(0) + r[3].charAt(0);
                  return r.join("")
      ...
      var q, j, H, V = (j = "[\\s|\\(]+(" + (q = "(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)") + ")[,|\\s]+(" + q + ")[,|\\s]+(" + q + ")\\s*\\)?", H = "[\\s|\\(]+(" + q + ")[,|\\s]+(" + q + ")[,|\\s]+(" + q + ")[,|\\s]+(" + q + ")\\s*\\)?", {
  ...
  var i = n(3),
      ...
      Y = function(t, e) {
          g(t);
          for (var n, i = b(e = x(e)), o = 0, r = i.length; r > o;) W(t, n = i[o++], e[n]);
          return t
      },
      K = function(t) {
      ...
      X = function(t) {
          for (var e, n = T(x(t)), i = [], r = 0; n.length > r;) o(D, e = n[r++]) || e == R || e == l || i.push(e);
          return i
      },
      Q = function(t) {
          for (var e, n = t === q, i = T(n ? L : x(t)), r = [], s = 0; i.length > s;) !o(D, e = i[s++]) || n && !o(q, e) || r.push(D[e]);
          return r
      };
  j || (a((N = function() {
  ...
  s(s.S + s.F * !j, "Symbol", {
      ...
      stringify: function(t) {
          ...
          if (n = e = i[1], (y(e) || void 0 !== t) && !U(t)) return m(e) || (e = function(t, e) {
      ...
      if ("c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length) {
          ...
          i = function(t, e) {
              ...
              for (a || (i = new RegExp("^" + b.source + "$(?!\\s)", p));
                  (l = b.exec(n)) && !((c = l.index + l[0].length) > f && (d.push(n.slice(f, l.index)), !a && l.length > 1 && l[0].replace(i, function() {
                      for (h = 1; h < arguments.length - 2; h++) void 0 === arguments[h] && (l[h] = void 0)
                  }), l.length > 1 && l.index < n.length && s.apply(d, l.slice(1)), u = l[0].length, f = c, d.length >= v));) b.lastIndex === l.index && b.lastIndex++;
      ...
      R = function(t) {
          m.call(l, function() {
              ...
              if (r && (e = x(function() {
                  ...
                  }), t._h = I || $(t) ? 2 : 1), t._a = void 0, r && e.e) throw e.v
          })
      },
      $ = function(t) {
  ...
  i(i.G + i.W + i.F * (u !== d), {
      ...
      slice: function(t, e) {
          ...
          for (var n = s(this).byteLength, i = a(t, n), o = a(void 0 === e ? n : e, n), r = new(h(this, d))(l(o - i)), c = new p(this), u = new p(r), f = 0; i < o;) u.setUint8(f++, c.getUint8(i++));
          return r
      }
  }), n(44)("ArrayBuffer")
}, function(t, e, n) {
  ...
  i(i.S, "Object", {
      getOwnPropertyDescriptors: function(t) {
          for (var e, n, i = r(t), l = s.f, c = o(i), u = {}, h = 0; c.length > h;) void 0 !== (n = l(i, e = c[h++])) && a(u, e, n);
          return u
      }
  })
}, function(t, e, n) {
  ...
  t.exports = {
      ...
      _last: function() {
          for (var t = this._state.keys.length - this._state.polyphony; t < this._state.keys.length; t++) this._state.keys[t].isActive = !0
      },
      _first: function() {
  ...
  */
  ...
  class y {
      ...
      connect() {
          g(this._target) ? this._listenSlots([this._target]) : this._target.children && (this._listenSlots(this._target.children), window.ShadyDOM ? this._shadyChildrenObserver = ShadyDOM.observeChildren(this._target, t => {
  ...
  class _ extends i.a {
      ...
      constructor() {
          super(), this.selectedIndex = -1, this.options = [], this._observer = new y(this, t => {
              this.options = [...this.options, ...t.addedNodes.filter(t => "option" === t.nodeName.toLowerCase())], this.options.length && -1 === this.selectedIndex && (this.selectedIndex = 0), this.requestUpdate()
          })
      }
      updated(t) {
      ...
      set value(t) {
          const e = this.options.findIndex(e => e.getAttribute("value") === t.toString()); - 1 !== e && (this.selectedIndex = e)
      }
      sync(t) {
  ...
  customElements.define("tone-rack", class extends i.a {
      ...
      updated(t) {
          const e = t => {
              t.dispatchEvent(new CustomEvent("collapse", {
                  detail: this.collapsed,
                  composed: !0,
                  bubbles: !0
              }))
          };
          t.has("collapsed") && (e(this), Array.from(this.children).forEach(t => {
              t.assignedNodes ? Array.from(t.assignedNodes()).forEach(t => e(t)) : e(t), t.dispatchEvent(new CustomEvent("collapse", {
                  detail: this.collapsed,
                  composed: !0,
                  bubbles: !0
              }))
  ...
  customElements.define("tone-player", class extends o.a {
      ...
      bind(t) {
          const e = setInterval(() => {
              t.loaded && (clearInterval(e), this.duration = t.buffer.duration, this.sync(t))
          }, 100);
          super.bind(t)
      }
      render() {
  ...
  customElements.define("n", class extends i.a {
      constructor() {
          super(), this._waveform = new Tone.Waveform(256)
      }
      bind(t) {
          t.connect(this._waveform), this._canvas = this.shadowRoot.querySelector("canvas"), this._canvas.width = 2 * this._canvas.clientWidth, this._canvas.height = 2 * this._canvas.clientHeight, this._context = this._canvas.getContext("2d"), this.loop(), window.addEventListener("resize", () => {
              this._canvas.width = 2 * this._canvas.clientWidth, this._canvas.height = 2 * this._canvas.clientHeight
          })
      }
      loop() {
  ...
  customElements.define("tone-microphone", class extends o.a {
      ...
      async bind(t) {
          ...
          this.shadowRoot.querySelector("#mic").addEventListener("click", n => {
              k(), this.open ? t.close() : t.open(e.value)
          }), e.addEventListener("change", n => {
              this.open && t.open(e.value)
          }), this.shadowRoot.querySelector("tone-oscilloscope").bind(t), this.inputs = await Tone.UserMedia.enumerateDevices(), this.requestUpdate()
      }
      render() {
          return i.b `
    <style>
      ...
      mousedown(t) {
          if (t.buttons) {
              const {
                  x: e,
                  y: n
              } = this._eventToXY(t), i = this.value.length;
              if (this.value[Math.floor(e * this.length)] = n, i !== this.value.length)
                  for (let t = 0; t < this.value.length; t++) this.value[t] || (this.value[t] = 0);
  ...
  customElements.define("tone-midi-in", class extends i.a {
      constructor() {
          super(), z.a.enable(t => {
              t && error(t), z.a.addListener("connected", t => {
      ...
      _connectMidi(t) {
          if ("none" === t.target.value) return void this.shadowRoot.querySelector("#light").classList.remove("connected");
  ...
  customElements.define("tone-piano", class extends i.a {
      ...
      bind(t) {
          this.addEventListener("noteon", e => {
              ...
              this.polyphonic ? t.triggerRelease(e.detail.name) : t.triggerRelease()
          })
      }
      firstUpdated() {
          super.firstUpdated();
          ...
          }), window.addEventListener("resize", this._resize.bind(this)), setTimeout(() => this._resize(), 100)
      }
      _resize() {
  ...
  customElements.define("tone-step-sequencer", class extends i.a {
      ...
      _mousemove(t, e, n) {
          if (t.cancelable && t.preventDefault(), t.buttons) this.values[e][n] = this.adding, this.requestUpdate();
  ...
  customElements.define("tone-meter", class extends i.a {
      ...
      bind(t) {
          ...
          } else this._meters = [new Tone.Meter(.9)], t.connect(this._meters[0]);
          this._canvas = this.shadowRoot.querySelector("canvas"), this._canvas.width = 2 * this._canvas.clientWidth, this._canvas.height = 2 * this._canvas.clientHeight, this._context = this._canvas.getContext("2d"), this.loop(), window.addEventListener("resize", () => {
              this._canvas.width = 2 * this._canvas.clientWidth, this._canvas.height = 2 * this._canvas.clientHeight
          })
      }
      loop() {
          ...
          const {
              width: t,
              height: e
          } = this._canvas, n = this._meters.map(t => t.getLevel()), i = n.map(t => Math.clamp(Math.scale(t, -100, 6, 0, e), 4, e));
          ...
          }), this.level && Array.from(this.shadowRoot.querySelectorAll(".level")).forEach((t, e) => {
              let i = n[e];
  ...
  customElements.define("tone-channel", class extends o.a {
      ...
      bind(t) {
          this.shadowRoot.querySelector("tone-meter").bind(t), this.addEventListener("mute", e => {
              t.mute = e.detail
  ...
  customElements.define("tone-transport", class extends o.a {
      ...
      bind(t) {
          super.bind(t), this.shadowRoot.querySelector("tone-play-toggle").bind(t), setInterval(() => {
              this.shadowRoot.querySelector("#position").textContent = t.position
          }, 100)
      }
      render() {
          return i.b `
  ...
  customElements.define("tone-unmute", class extends o.a {
      ...
      constructor() {
          super(), this.suspended = !0, this.muted = !1, this.focused = !1, setInterval(() => {
  ...
  customElements.define("tone-top-bar", class extends i.a {
      ...
      updated() {
          ...
          const {
              width: e,
              height: n
          } = t, i = t.getContext("2d"), o = function(t) {
              const e = new Array(t),
                  n = new Array(t),
                  i = new Array(t),
                  o = new Array(t),
              ...
              for (let e = 0; e < t; e++) o[e] = e < t / 3 ? e / (t / 3) * 2 - 1 : e < 2 * t / 3 ? 2 * (1 - (e - t / 3) / (t / 3)) - 1 : (e - 2 * t / 3) / (t / 3) * 2 - 1;
              for (let e = 0; e < t; e++) {
                  const i = t / 16;
      ...
      updated(t) {
          if (t.has("collapsed") && !this.collapsed) {
              ...
              Array.from(this.children).forEach(e => {
                  e.assignedNodes ? Array.from(e.assignedNodes()).forEach(e => t(e)) : t(e), e.dispatchEvent(new CustomEvent("collapse", {
                      detail: this.collapsed,
                      composed: !0,
                      bubbles: !0
                  }))
  ...
  customElements.define("tone-loader", class extends i.a {
      ...
      constructor() {
          super(), this.progress = 0, this.loaded = !1, Tone.Buffer.on("progress", t => {
              this.progress = t
          }), Tone.loaded().then(() => {
              this.loaded = !0, setTimeout(() => {
                  this.remove()
              }, 500)
          })
      }
  ...
  customElements.define("tone-start-context", class extends i.a {
      ...
      firstUpdated() {
          const t = setInterval(() => {
              this.running = "running" === Tone.context.state, this.running && clearInterval(t)
          }, 100)
      }
      async _clicked(t) {
  ...
  customElements.define("tone-fft", class extends i.a {
      ...
      bind(t) {
          t.connect(this._fft), this._canvas = this.shadowRoot.querySelector("canvas"), this._canvas.width = 2 * this._canvas.clientWidth, this._canvas.height = 2 * this._canvas.clientHeight, this._context = this._canvas.getContext("2d"), this.loop(), window.addEventListener("resize", () => {
              this._canvas.width = 2 * this._canvas.clientWidth, this._canvas.height = 2 * this._canvas.clientHeight
          })
      }
      loop() {
  ...
  customElements.define("tone-loop", class extends i.a {
      ...
      bind(t) {
          this._canvas = this.shadowRoot.querySelector("canvas"), this._canvas.width = 2 * this._canvas.clientWidth, this._canvas.height = 2 * this._canvas.clientHeight, this._context = this._canvas.getContext("2d"), this.loop(t), window.addEventListener("resize", () => {
              this._canvas.width = 2 * this._canvas.clientWidth, this._canvas.height = 2 * this._canvas.clientHeight
          })
      }
      loop(t) {
  ...
  customElements.define("tone-reverb", class extends nt {
      ...
      bind(t) {
          ...
          this.addEventListener("change", () => {
              this.generating = !0, clearTimeout(e), e = setTimeout(() => {
                  this.generate(t)
              }, 100)
          })
      }
