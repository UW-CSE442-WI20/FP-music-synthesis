...
},{"./src/slider.js":"../node_modules/d3-simple-slider/src/slider.js"}],"pitch.js":[function(require,module,exports) {
"use strict";

var d3 = _interopRequireWildcard(require("d3"));

var _d3SimpleSlider = require("d3-simple-slider");
...
svg.append("defs").append("clipPath").attr("id", "clip").append("rect").attr("width", w).attr("height", h); // xAxis = d3.svg.axis().scale(xScale).ticks(10).orient('bottom');
...
var pitchSlider = (0, _d3SimpleSlider.sliderHorizontal)().min(0.01).max(10).width(300).displayValue(true).tickFormat(d3.format('1')).default(pitch).on('onchange', function (val) {
  updatePitch(val);
});
d3.select('#pitch-slider').append('svg').attr('width', 300 + 50).attr('height', 100).append('g').attr('transform', 'translate(30,30)').call(pitchSlider);
},{"d3":"../node_modules/d3/index.js","d3-simple-slider":"../node_modules/d3-simple-slider/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","pitch.js"], null)
//# sourceMappingURL=/pitch.227f1f1f.js.map